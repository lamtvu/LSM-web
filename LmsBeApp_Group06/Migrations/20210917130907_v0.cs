        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClassAdminId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Classes_Users_AssistantId",
                        column: x => x.AssistantId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Classes_Users_ClassAdminId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsLook = table.Column<bool>(type: "bit", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Image = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequestTeachers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RequestTeachers_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RequestStudents_Classes_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Classes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RequestStudents_Users_SenderId",
                        column: x => x.SenderId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubmissionExercises", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubmissionExercises_Exercises_ExerciseId",
                        column: x => x.ExerciseId,
                        principalTable: "Exercises",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SubmissionExercises_Users_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubmisstionQuizzes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubmisstionQuizzes_Quizzes_QuizId",
                        column: x => x.QuizId,
                        principalTable: "Quizzes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SubmisstionQuizzes_Users_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SubmissionQuizId = table.Column<int>(type: "int", nullable: false),
                    AnswerId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuizAnswers", x => new { x.AnswerId, x.SubmissionQuizId });
                    table.ForeignKey(
                        name: "FK_QuizAnswers_Answers_AnswerId",
                        column: x => x.AnswerId,
                        principalTable: "Answers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_QuizAnswers_SubmisstionQuizzes_SubmissionQuizId",
                        column: x => x.SubmissionQuizId,
                        principalTable: "SubmisstionQuizzes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizAnswers_SubmissionQuizId",
                table: "QuizAnswers",
                column: "SubmissionQuizId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestStudents_ClassId",
                table: "RequestStudents",
                column: "ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_RequestStudents_SenderId",
                table: "RequestStudents",
                column: "SenderId");

            migrationBuilder.CreateIndex(
                name: "IX_RequestTeachers_UserId",
                table: "RequestTeachers",
                column: "UserId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubmissionExercises_ExerciseId",
                table: "SubmissionExercises",
                column: "ExerciseId");

            migrationBuilder.CreateIndex(
                name: "IX_SubmissionExercises_StudentId",
                table: "SubmissionExercises",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_SubmisstionQuizzes_QuizId",
                table: "SubmisstionQuizzes",
                column: "QuizId");

            migrationBuilder.CreateIndex(
                name: "IX_SubmisstionQuizzes_StudentId",
                table: "SubmisstionQuizzes",
                column: "StudentId");
