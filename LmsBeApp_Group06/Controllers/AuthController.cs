...
Microsoft.Extensions.Configuration.IConfiguration configuration
    ...
    public async Task<ActionResult<Response<string>>> GetVerifyGmail(string email)
    {
      ...
      var mailContent = new MailContent
      {
        ...
        Body = MailHtmlForm.VetifyForm(userModel.Username, "techedu.com", " " + _configuration.GetValue<string>("BEHost") + "/api/auth/verify?token=" + token, "techedu.ltv@gmail.com")
      };
    ...
    public async Task<ActionResult> VerifyEmail(string token)
    {
      ...
      return Redirect(_configuration.GetValue<string>("FEHost") + "/login");
    }
